...
function getlink(value, linktype) {
    switch (linktype) {
        ...
        break;
        case 'generic':
             return '<a class="pointer" onclick="handleClick(\'' + value.name + '\', \'' + value.release_date + '\', \'' + value.year + '\')">';
        break;
        case 'album':
...
function getsearchbox(keys, filterelement, item) {
    let text = "";
    ...
    if (data)
        ...
        switch (listtype){
            case 'data':
              ...
              text += '</tr></thead>';
              text += getsearchbox(keys, filterelement, item);
              break;
           case 'list':
                text += "<table class='sortable' id='datatable'>";
                text += getsearchbox(keys, filterelement, item);
